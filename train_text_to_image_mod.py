...
def main():
    ...
    if version.parse(accelerate.__version__) >= version.parse("0.16.0"):
        ...
        def load_model_hook(models, input_dir):
            if args.use_ema:
                ...
                load_vae = EMAModel.from_pretrained(os.path.join(input_dir, "vae_ema"), AutoencoderKL)
                ema_vae.load_state_dict(load_vae.state_dict())
                ema_vae.to(accelerator.device)
                del load_model,load_vae
            ...
            for _ in range(len(models)):
                ...
                load_vae = AutoencoderKL.from_pretrained(input_dir,subfolder="vae")
    ...
    optimizer = optimizer_cls(
        itertools.chain(unet.parameters(), vae.parameters()),
